...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { fontSize: 10, marginTop: 2, fontWeight: '500', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  refreshBtn: {
    width: 34,
    height: 34,
    borderRadius: 17,
  ...
  filterCountText: { color: '#FFFFFF', fontSize: 8, fontWeight: '700', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  filterPanel: {
    marginHorizontal: 16,
    marginBottom: 8,
    borderRadius: 16,
  ...
  filterPanelTitle: { fontSize: 13, fontWeight: '700', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  clearText: { fontSize: 12, fontWeight: '600', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  filterSectionLabel: { fontSize: 10, fontWeight: '700', marginBottom: 8, letterSpacing: 0.5, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  ...
  chipText: { fontSize: 11, fontWeight: '600', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  ...
  quickChipText: { fontSize: 11, fontWeight: '700', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  ...
  foodTypeText: { fontSize: 13, fontWeight: '700', flex: 1, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  statusBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 3,
  ...
  quantityText: { fontSize: 12, fontWeight: '500', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  ...
  freshnessLabel: { fontSize: 9, fontWeight: '700', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  cardBottom: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  addressText: { fontSize: 10, flex: 1, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  ...
  emptyTitle: { fontSize: 16, fontWeight: '700', marginBottom: 8, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  emptyDesc: { fontSize: 12, textAlign: 'center', lineHeight: 18, marginBottom: 20, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  clearBtn: {
    borderWidth: 1,
    paddingVertical: 8,
  ...
  clearBtnText: { fontSize: 12, fontWeight: '700', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
});
