...
import { ArrowLeft, Bell, CheckCheck, Package, Truck, Star, Zap } from 'lucide-react';
...
const styles = StyleSheet.create({
  ...
  markAllText: { fontSize: 11, fontWeight: '700', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32 },
  emptyTitle: { fontSize: 18, fontWeight: '800', marginBottom: 8, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  emptyDesc: { fontSize: 13, textAlign: 'center', lineHeight: 20, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  list: { padding: 16, paddingBottom: 32 },
  sectionLabel: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, marginTop: 4, gap: 6 },
  sectionDot: { width: 6, height: 6, borderRadius: 3 },
  sectionLabelText: { fontSize: 10, fontWeight: '800', letterSpacing: 1.2, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  notifCard: {
  ...
  notifTitle: { fontSize: 13, flex: 1, marginRight: 8, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  unreadDot: { width: 8, height: 8, borderRadius: 4 },
  notifMessage: { fontSize: 11, lineHeight: 16, marginBottom: 5, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  notifTime: { fontSize: 9, fontWeight: '600', fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
  tipBox: {
    flexDirection: 'row', alignItems: 'center', borderRadius: 14, borderWidth: 1,
    padding: 12, marginTop: 8,
  },
  tipText: { flex: 1, fontSize: 11, lineHeight: 16, fontFamily: 'Outfit, system-ui, -apple-system, sans-serif' },
});
